...
module.exports = (app) => {
    app.get('/atividades', async (req, res) => {
        //para capturar o id da barra de endereço
        var id = req.query.id
        //para buscar o nome na collection usuarios
        var user = await usuarios.findOne({ _id: id })
        //para buscar todas as atividades desse usuário
    ...
    app.post('/atividades', async (req, res) => {
        ...
        //para conectar com o database
        const conexao = require('../config/database')()
        //model atividades
        const atividades = require('../models/atividades')
        //para salvar as informações do formulário no database
